    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-2 md:w-1/2 md:items-end md:text-right mt-4 md:mt-0">
          <div className="flex items-start gap-2">
            <CalendarDays className="mt-1" size={16} aria-hidden />
            <span>
              <strong>Duration:</strong> 4 months
            </span>
          </div>
          <div className="flex items-start gap-2">
            <Globe className="mt-1" size={16} aria-hidden />
            <span>
          ...
          <table className="w-full border border-gray-300 rounded shadow-sm">
            ...
            <tbody>
              {[
                [
                  'Hardware Setup',
                  'Ad-hoc camera models & cables',
                  'Pre-defined “Evercam Edge Kit” with validated SBC + camera + storage',
                ],
                [
                  'Camera Configs',
                  'Manual resolution/stream tuning',
                  'YAML-based config profiles auto-pushed via OTA',
                ],
                [
                  'Deployment Workflow',
                  'Manual SSH into each device',
                  'Ansible playbooks for OTA + AWX UI for non-devs',
                ],
                [
                  'Support Tools',
                  'Devs required for reset/troubleshooting',
                  'Support team trained to push configs via UI',
                ],
                [
                  'Version Control',
                  'Untracked, undocumented versions',
                  'Firmware + software versions tracked centrally',
                ],
              ].map((row, i) => (
                <tr
                  key={i}
      ...
      >
        <h2 className="text-2xl font-semibold mb-3">
          <ServerCog
            ...
            aria-hidden
          />
          Architecture Shift: From Camera-Based to Kit-Based
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-lg">
          <div className="bg-red-50 p-4 border rounded">
            <h3 className="font-bold mb-2">Old Model (Camera-Centric)</h3>
            <p>
              → Each site had Custom camera & Custom config
              <br />
              → No standard hardware components
              <br />
          ...
          <div className="bg-green-50 p-4 border rounded">
            ...
            <p>
              →Pre-approved Edge Kit (SBC + Camera)
              <br />
              → Standard firmware
              <br />
              → Auto-config (Ansible)
              ...
              → UI-driven OTA (AWX)
              <br />
              → 1-click config deployment via web UI
              <br />
              → No dev needed for pushing updates or resets
              <br />
      ...
      >
        <h2 className="text-2xl font-semibold mb-3">
          <Users
            className="inline mr-2 mb-1 text-purple-600"
            size={18}
            aria-hidden
          />
          Cross-Functional Collaboration
        ...
        <ul className="list-disc ml-6 text-gray-700 text-lg space-y-1">
          <li>
            <strong>Firmware Team:</strong> Helped define baseline image and upgrade strategy
          </li>
          <li>
            <strong>DevOps:</strong> Built Ansible and AWX stack, managed CI/CD
          </li>
          <li>
            <strong>Developers:</strong> Created modular components for containerized deployment
          </li>
          <li>
            <strong>Support/Field Ops:</strong> Trained to use UI to deploy and reset devices
          </li>
          <li>
            <strong>QA:</strong> Validated kit stability across diverse site conditions
          </li>
        </ul>
      </motion.section>
      ...
      >
        ...
        <ul className="list-disc ml-6 text-gray-700 text-lg space-y-1">
          <li>
            Shift from ad-hoc, camera-based deployments to a standardized kit-based architecture drastically improved scalability and reliability.
          </li>
          <li>
            Centralized version control for hardware, firmware, and software eliminated tech debt and inconsistency.
          </li>
          <li>
            Automation via Ansible + AWX empowered non-technical teams to deploy configs and updates without developer support.
          </li>
          <li>
            Cross-functional collaboration across firmware, DevOps, development, support, and QA teams accelerated rollout success.
          </li>
          <li>
            Reduced deployment errors and support overhead, enabling faster site onboarding for 627+ projects worldwide.
          </li>
        </ul>
      </motion.section>
