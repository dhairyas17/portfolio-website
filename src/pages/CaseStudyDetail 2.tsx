  ...
  return (
    ...
    >
      ...
      <motion.h1 className="text-4xl font-bold mb-6 leading-snug" {...fadeIn}>
        📌 Case Study: Standardizing Edge Setup at Evercam for Scalable Video Deployment
      </motion.h1>
      ...
      {/* Contact / Next Steps */}
      <motion.section {...fadeIn}>
        <h2 className="text-2xl font-semibold mb-3"><MessageCircle className="inline mr-2 mb-1 text-indigo-600" size={18} />Get in Touch</h2>
        <p className="text-gray-700 text-sm">
          Interested in learning more about this case study or discussing a similar project? Reach out to me for a chat!
        </p>
        <button
