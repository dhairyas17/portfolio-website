  ...
  return (
    ...
    >
      ...
      >
        ...
        <ul className="list-disc ml-6 text-gray-700 text-lg space-y-1">
          <li>
            <strong>Prioritization:</strong> Chose classes with the highest false-negative impact to annotate first.
          </li>
          <li>
            <strong>Automation vs. Accuracy:</strong> Balanced automated data scraping and annotation speed with human QA to maintain precision.
          </li>
          <li>
            <strong>Tooling:</strong> Evaluated between Kubeflow vs Airflow and selected Airflow for simplicity and better integration with our existing stack.
          </li>
        </ul>
      </motion.section>
