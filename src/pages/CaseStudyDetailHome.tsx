...
// Main Component
// ----------------------
export default function CaseStudyHomeComponent() {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-8 py-12 font-sans text-gray-900 space-y-10">
        <div key={cs.id} className="space-y-10">
          ...
          <motion.button
  className="flex items-center gap-2 text-lg text-blue-600 hover:text-blue-800 mb-8 transition no-underline"
  onClick={goBack}
  {...fadeIn}
>
