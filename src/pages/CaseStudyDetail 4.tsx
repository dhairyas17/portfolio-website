...
const CaseStudyDetail4 = () => {
  ...
  return (
    ...
    >
      ...
      <motion.section className="mb-10" {...fadeIn}>
        <h2 className="text-2xl font-semibold mb-3">
          <Hammer className="inline mr-2 mb-1 text-cyan-600" size={18} />
          Key Features
        </h2>
        <ul className="list-disc ml-6 text-gray-700 text-lg space-y-1">
      ...
      <motion.section className="mb-10" {...fadeIn}>
        <h2 className="text-2xl font-semibold mb-3">
          <ServerCog className="inline mr-2 mb-1 text-cyan-600" size={18} />
          System Architecture
        </h2>
      ...
      <motion.section className="mb-10" {...fadeIn}>
        <h2 className="text-2xl font-semibold mb-3">
          <Tags className="inline mr-2 mb-1 text-blue-600" size={18} />
          API Gateway
        </h2>
      ...
      <motion.section className="mb-10" {...fadeIn}>
        <h2 className="text-2xl font-semibold mb-3">
          <Users className="inline mr-2 mb-1 text-teal-600" size={18} />
          Cross-Functional Touch
        </h2>
