...
const CaseStudyDetail3 = () => {
  ...
  return (
    ...
    >
      ...
      <motion.section
        id="product-design"
        aria-labelledby="product-design-heading"
        className="mb-10 p-6 rounded-lg shadow-lg bg-white border border-gray-200"
        {...fadeIn}
      >
        <h2
          id="product-design-heading"
          className="text-2xl font-semibold mb-3"
        >
          <LayoutDashboard
            className="inline mr-2 mb-1 text-indigo-600"
      ...
      >
        ...
        <motion.div className="mt-6" {...fadeIn}>
          <img
            ...
            alt="Architecture diagram showing real-time observability setup with Prometheus and Grafana"
        ...
        <motion.div className="mt-6" {...fadeIn}>
          <img
            ...
            alt="Screenshot of Grafana dashboard displaying device health metrics"
            className="rounded-lg shadow-lg border border-gray-200 w-full mt-6"
          />
      ...
      >
        ...
        >
          <Hammer
            className="inline mr-2 mb-1 text-orange-600"
            size={18}
            aria-hidden="true"
          />
          Key Product & Technical Decisions
        ...
        <div className="overflow-x-auto text-lg">
          <table className="w-full border border-gray-300 rounded shadow-sm">
            ...
            <tbody>
              {technicalDecisionsRows.map((row, i) => (
                <tr key={i} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                  {row.map((cell, j) => (
                    <td key={j} className={tableRowStyles}>
                      {cell}
